    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('comp_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Scheduler.Company_Details')),
                ('contact_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Scheduler.Contact_alumini')),
        ...
        migrations.AddField(
            ...
            name='office_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Scheduler.Office_Types'),
        ),
        migrations.AddField(
            model_name='contact_alumini',
            name='user',
