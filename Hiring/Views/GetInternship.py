...
def get_internship_user(request, format=None):
    ...
    return Response({'response' : [{ 'internship_info_id' :e.internship_id, 'intern_profile_ctc' : e.intern_profile_ctc ,'school_name':e.school_id.school_name , 'intern_offers':e.intern_offers } for e in internship_details]}, status=status.HTTP_200_OK)